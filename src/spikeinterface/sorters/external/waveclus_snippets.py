        ...
        if cls.check_compiled():
            ...
            if "win" in sys.platform and sys.platform != "darwin":
                ...
                shell_cmd = f"""
                    ...
                    {get_matlab_path()} -nosplash -wait -log -r "waveclus_snippets_master('{sorter_output_folder}', '{sorter_path}')"
                """
            else:
                shell_cmd = f"""
                    #!/bin/bash
                    cd "{sorter_output_folder}"
                    {get_matlab_path()} -nosplash -nodisplay -log -r "waveclus_snippets_master('{sorter_output_folder}', '{sorter_path}')"
                """
